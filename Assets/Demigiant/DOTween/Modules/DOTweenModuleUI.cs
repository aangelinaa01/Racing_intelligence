...
namespace DG.Tweening
{
	public static class DOTweenModuleUI
    {
        ...
        /// <summary>Tweens a UIOutline's effectColor to the given value.
        /// Also stores the UIOutline as the tween's target so it can be used for filtered operations</summary>
        /// <param name="endValue">The end value to reach</param><param name="duration">The duration of the tween</param>
        public static TweenerCore<Color, Color, ColorOptions> DOColor(this UIOutline target, Color endValue, float duration)
        {
        ...
        /// <summary>Tweens a UIOutline's effectColor alpha to the given value.
        /// Also stores the UIOutline as the tween's target so it can be used for filtered operations</summary>
        /// <param name="endValue">The end value to reach</param><param name="duration">The duration of the tween</param>
        public static TweenerCore<Color, Color, ColorOptions> DOFade(this UIOutline target, float endValue, float duration)
        {
        ...
        /// <summary>Tweens a UIOutline's effectDistance to the given value.
        /// Also stores the UIOutline as the tween's target so it can be used for filtered operations</summary>
        /// <param name="endValue">The end value to reach</param><param name="duration">The duration of the tween</param>
        public static TweenerCore<Vector2, Vector2, VectorOptions> DOScale(this UIOutline target, Vector2 endValue, float duration)
        {
